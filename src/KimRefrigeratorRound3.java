...
public class KimRefrigeratorRound3 {
	...
	public static void main(String[] args) {
		...
		System.out.println(checkMinDistance(0,1));
		
	}
	
	static int checkMinDistance(int current, int visited)
	{
		...
		for(int i =0; i < graph.length; i++)
		{
			...
			dp[current][visited] = Math.min(dp[current][visited], graph[current][i] + checkMinDistance(i,visited | (1 << i)));
		}
